...
func (sd *StepDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(step.Table, sqlgraph.NewFieldSpec(step.FieldID, field.TypeUint64))
...
// Where appends a list predicates to the StepDelete builder.
func (sdo *StepDeleteOne) Where(ps ...predicate.Step) *StepDeleteOne {
